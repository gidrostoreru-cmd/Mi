...
const DEFAULT_SETTINGS = {
  ...
  /* Поставщики услуг (редактируются в разделе «Админ») — для квитанций и реестров обмена */
  providers: {
    cold:  'ООО «НОВОГОР-Прикамье»',
    sewer: 'ООО «НОВОГОР-Прикамье»',
    hot:   'ПАО «Т Плюс»',
    heat:  'ПАО «Т Плюс»',
    gas:   'ООО «Газпром межрегионгаз Пермь»',
    elec:  'ПАО «Пермэнергосбыт»',
    tko:   'УК «Мой дом»',
  },
